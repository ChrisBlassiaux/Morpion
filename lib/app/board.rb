class Board
  ...
  def game_won_or_game_bad?
    if ((@boardcase[0].content == "X") && (@boardcase[1].content == "X") && (@boardcase[2].content == "X")) || ((@boardcase[3].content == "X") && (@boardcase[4].content == "X") && (@boardcase[5].content == "X")) || ((@boardcase[6].content == "X") && (@boardcase[7].content == "X") && (@boardcase[8].content == "X")) || ((@boardcase[0].content == "X") && (@boardcase[3].content == "X") && (@boardcase[6].content == "X")) || ((@boardcase[1].content == "X") && (@boardcase[4].content == "X") && (@boardcase[7].content == "X")) || ((@boardcase[2].content == "X") && (@boardcase[5].content == "X") && (@boardcase[8].content == "X")) || ((@boardcase[6].content == "X") && (@boardcase[4].content == "X") && (@boardcase[2].content == "X")) || ((@boardcase[0].content == "X") && (@boardcase[4].content == "X") && (@boardcase[8].content == "X"))
      return true
    elsif ((@boardcase[0].content == "O") && (@boardcase[1].content == "O") && (@boardcase[2].content == "O")) || ((@boardcase[3].content == "O") && (@boardcase[4].content == "O") && (@boardcase[5].content == "O")) || ((@boardcase[6].content == "O") && (@boardcase[7].content == "O") && (@boardcase[8].content == "O")) || ((@boardcase[0].content == "O") && (@boardcase[3].content == "O") && (@boardcase[6].content == "O")) || ((@boardcase[1].content == "O") && (@boardcase[4].content == "O") && (@boardcase[7].content == "O")) || ((@boardcase[2].content == "O") && (@boardcase[5].content == "O") && (@boardcase[8].content == "O")) || ((@boardcase[6].content == "O") && (@boardcase[4].content == "O") && (@boardcase[2].content == "O")) || ((@boardcase[0].content == "O") && (@boardcase[4].content == "O") && (@boardcase[8].content == "O"))
      return true
